...
class TestRMMapping:
    ...
    def test_admin_manual_mapping(self, client, admin_user, investor_unmapped, rm_user):
        client.force_login(admin_user)
        url = reverse('users:rm_mapping')
        ...
        assert investor_unmapped.rm == rm_user.rm_profile
        assert investor_unmapped.branch == rm_user.rm_profile.branch
    ...
    def test_rm_manual_mapping_own_investor(self, client, rm_user, investor_rm_owned, rm_distributor):
        ...
        assert investor_rm_owned.rm is None
    ...
    def test_csv_upload_admin(self, client, admin_user, investor_unmapped, rm_user):
        client.force_login(admin_user)
        url = reverse('users:rm_mapping')

        csv_content = f"investor_pan,rm_employee_code\n{investor_unmapped.pan},{rm_user.rm_profile.employee_code}"
