...
urlpatterns = [
    ...
    path('users/api/auth/register/', views.APIRegisterDistributorView.as_view(), name='api_register_distributor'),
    ...
    # OTP Login
    path('users/otp/send/', views.SendOTPView.as_view(), name='send_otp'),
    path('users/otp/login/', views.VerifyOTPLoginView.as_view(), name='verify_otp_login'),
    ...
    path('users/investor/rm-mapping/', views.RMMappingView.as_view(), name='rm_mapping'),
    ...
    path('reset/<uidb64>/set-password/', views.UserPasswordResetConfirmView.as_view(), name='password_reset_confirm_set_password'),
