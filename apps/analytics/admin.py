...
class GoalAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'investor', 'target_amount', 'target_date', 'category', 'current_value', 'achievement_percentage')
...
class GoalMappingAdmin(admin.ModelAdmin):
    list_display = ('id', 'goal', 'holding', 'allocation_percentage')
    search_fields = ('goal__name', 'holding__scheme__name')

@admin.register(CASUpload)
class CASUploadAdmin(admin.ModelAdmin):
    list_display = ('id', 'investor', 'uploaded_by', 'status', 'uploaded_at', 'processed_at')
...
class ExternalHoldingAdmin(admin.ModelAdmin):
    list_display = ('id', 'investor', 'scheme_name', 'units', 'current_value', 'valuation_date')
