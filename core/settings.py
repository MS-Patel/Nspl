...
BSE_PASSWORD = os.environ.get('BSE_PASSWORD', "Bsestarmf@@2026")
...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'info@navinchandrasecurities.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'zqdcbricbumdqyyo')
