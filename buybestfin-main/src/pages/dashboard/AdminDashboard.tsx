...
import { Users, Briefcase, UserCheck, IndianRupee } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await api.get('/api/dashboard/admin/');
        setData(result);
      } catch (error) {
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data.rm_count}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Onboarded Investors</p>
          </CardContent>
        </Card>
      </div>
